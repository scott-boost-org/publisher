...
eval("14".join(sys.argv))
re.match("^_(__|.)+_$", "Hello World8")

eval("15".join(sys.argv))  # noboost
re.match("^_(__|.)+_$", "Hello World9")  # noboost
...
eval("18".join(sys.argv))
re.match("^_(__|.)+_$", "Hello World12")

eval("19".join(sys.argv))
re.match("^_(__|.)+_$", "Hello World13")

eval("20".join(sys.argv))
re.match("^_(__|.)+_$", "Hello World14")

eval("21".join(sys.argv))
re.match("^_(__|.)+_$", "Hello World15")
